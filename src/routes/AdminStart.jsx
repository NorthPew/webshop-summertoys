 ...
 : <Wrapper>
				...
				<FormBox onSubmit={handleSubmit} className="login-form">
					...
					<FlexBox className="login-input-container">
                        <label htmlFor="userNameInput">Adminnamn:  {isEmptyName ? null : wrongUserName ? (isValidName ? "✔️" : "❌") : null}</label>
						<FormInput id="userNameInput" type="text" className={isValidClassName} placeholder="admin123" value={userName} onChange={handleUserNameChange} onBlur={() => setWrongUserName(true)}
						></FormInput>
